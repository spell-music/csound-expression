...
ftsamplebank b1 b2 b3 b4 b5 =
  ...
  where
    f a1 a2 a3 a4 a5 = opcs "ftsamplebank" [(Ir,[Sr,Ir,Ir,Ir,Ir]),(Kr,[Sr,Kr,Kr,Kr,Kr,Kr])] [a1
                                                                                            ,a2
                                                                                            ,a3
                                                                                            ,a4
                                                                                            ,a5]
...
tableimix b1 b2 b3 b4 b5 b6 b7 b8 b9 =
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 a8 a9 = opcsDep_ "tableimix" [(Xr,[Ir,Ir,Ir,Ir,Ir,Ir,Ir,Ir,Ir])] [a1
                                                                                            ,a2
                                                                                            ,a3
                                                                                            ,a4
                                                                                            ,a5
...
tablemix b1 b2 b3 b4 b5 b6 b7 b8 b9 =
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 a8 a9 = opcsDep_ "tablemix" [(Xr,[Kr,Kr,Kr,Kr,Kr,Kr,Kr,Kr,Kr])] [a1
                                                                                           ,a2
                                                                                           ,a3
                                                                                           ,a4
                                                                                           ,a5
