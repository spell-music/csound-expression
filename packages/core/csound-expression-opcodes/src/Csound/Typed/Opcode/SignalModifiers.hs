...
vdelayxq b1 b2 b3 b4 b5 b6 b7 =
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 =
      mopcs
        "vdelayxq"
        ([Ar, Ar, Ar, Ar], [Ar, Ar, Ar, Ar, Ar, Ir, Ir, Ir])
        [ a1
        , a2
        , a3
        , a4
  ...
  where
    f a1 a2 a3 a4 a5 =
      mopcs
        ...
        , [Ir, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar, Ar]
        )
        [a1, a2, a3, a4, a5]
...
spat3di b1 b2 b3 b4 b5 b6 b7 =
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 =
      mopcs
        "spat3di"
        ([Ar, Ar, Ar, Ar], [Ar, Ir, Ir, Ir, Ir, Ir, Ir, Ir])
        [ a1
        , a2
        , a3
        , a4
...
babo b1 b2 b3 b4 b5 b6 b7 =
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 =
      mopcs
        "babo"
        ([Ar, Ar], [Ar, Kr, Kr, Kr, Ir, Ir, Ir, Ir, Ir])
        [ a1
        , a2
        , a3
        , a4
  ...
  where
    f a1 a2 a3 a4 a5 a6 a7 a8 =
      mopcs
        "platerev"
        ( (repeat Ar)
        , [Ir, Ir, Kr, Ir, Ir, Ir, Ir] ++ (repeat Ar)
        )
...
filter2 b1 b2 b3 b4 =
  ...
  where
    f a1 a2 a3 a4 =
      opcs
        "filter2"
        [(Ar, [Ar] ++ (repeat Ir)), (Kr, [Kr] ++ (repeat Ir))]
        ( [ a1
          , a2
          , a3
          ]
