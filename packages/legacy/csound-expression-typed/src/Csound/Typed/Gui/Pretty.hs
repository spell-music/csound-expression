...
import Data.Colour.Names (black, gray, white)
import Data.Colour.SRGB
import Data.Default
import Data.Text (Text)
import Data.Text qualified as Text

import Text.PrettyPrint.Leijen.Text (Doc, char, comma, hcat, hsep, int, punctuate, textStrict)
import Text.PrettyPrint.Leijen.Text qualified as P (empty, (<+>))

import Csound.Dynamic (Rate (..), Var (..), VarType (..))
